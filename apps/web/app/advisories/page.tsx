  ...
  const sampleAdvisories: AdvisoryPayload[] = [
    {
      id: 'adv-01',
      level: 'orange',
      location: 'NH-44 Corridor, Km 142.0 – Km 143.5 (Panthyal Stretch, Ramban District)',
      reason: 'Elevated terrain slope instability exposure detected along mountain highway cut-slopes under dynamic 24h rainfall proxy scenarios.',
      suggestedAction: 'Delay non-essential transit along Ramban-Banihal stretch by 6 hours. Heavy freight staging at Udhampur.',
      ...
      expiryTime: 'Valid 6-Hour Window',
      verificationStatus: 'Research Advisory Prototype',
    },
    {
      id: 'adv-02',
      level: 'yellow',
      location: 'Mughal Road (Rajouri – Shopian Corridor via Peer Ki Gali)',
      reason: 'Moderate baseline slope vulnerability across high-elevation mountain passes.',
      suggestedAction: 'Exercise caution during intense or prolonged rainfall. Verify pass opening status before departure.',
      confidence: 'Moderate (Copernicus DEM 30m Morphometrics)',
      source: 'GeoSlide-JK 100m Master Grid',
      issuedTime: 'Today 08:00 IST',
      expiryTime: 'Valid 24-Hour Window',
      verificationStatus: 'Research Advisory Prototype',
    },
    {
      id: 'adv-03',
      level: 'green',
      location: 'Jammu – Udhampur Expressway (Km 0 – Km 65)',
      ...
      <main className="flex-1 p-4 max-w-5xl mx-auto w-full space-y-4">
        ...
        <div className="bg-navy-900 border border-navy-700 p-5 rounded-2xl space-y-2 shadow-xl">
          ...
          <p className="text-xs text-slate-300 leading-relaxed max-w-2xl">
            Standardized 4-tier risk advisories (Green, Yellow, Orange, Red) generated from 100m slope susceptibility rasters and dynamic rainfall scenarios.
          </p>
        </div>
