  ...
  const sampleAdvisories: AdvisoryPayload[] = [
    {
      id: 'adv-01',
      level: 'orange',
      location: 'NH-44 Mountain Corridor (Pilot Analysis Chainage KM 12.0 – KM 15.0)',
    ...
    },
    {
      ...
      suggestedAction: 'Research Scenario: Exercise caution during intense or prolonged rainfall. Verify pass opening status with official authorities.',
    ...
    },
    {
      ...
      suggestedAction: 'Normal travel precautions apply. Follow standard highway traffic rules.',
